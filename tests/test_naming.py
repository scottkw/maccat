...
class TestParseCatalogFilename:
    def test_valid_filename_returns_dataclass(self) -> None:
        result = parse_catalog_filename("mac-software-list-[personal]-20260614120000.md")
    ...
    def test_filename_field_preserved(self) -> None:
        fname = "mac-software-list-[personal]-20260614120000.md"
        result = parse_catalog_filename(fname)
        assert result is not None
        assert result.filename == fname

    def test_spaces_in_machine_name_allowed(self) -> None:
        result = parse_catalog_filename("mac-software-list-[My Computer]-20260614120000.md")
        assert result is not None
    ...
    def test_brackets_in_machine_name_returns_none(self) -> None:
        ...
        result = parse_catalog_filename("mac-software-list-[bad[bracket]]-20260614120000.md")
        assert result is None

    def test_13_digit_timestamp_returns_none(self) -> None:
        result = parse_catalog_filename("mac-software-list-[host]-2026061400.md")
        assert result is None

    def test_15_digit_timestamp_returns_none(self) -> None:
        result = parse_catalog_filename("mac-software-list-[host]-202606141200000.md")
        assert result is None
    ...
    def test_empty_machine_label_returns_none(self) -> None:
        ...
        result = parse_catalog_filename("mac-software-list-[]-20260614120000.md")
        assert result is None
...
class TestMakeCatalogFilename:
    def test_output_format(self) -> None:
        ...
        assert result == "mac-software-list-[personal]-20260614120000.md"
